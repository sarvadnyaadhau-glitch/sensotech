...
export default function Login({ onOpenSignIn, onOpenSignUp, lang }: LoginProps) {
  return (
    <div
      ...
      <div className="relative z-10 flex flex-col items-center px-6 text-center max-w-sm w-full">
        ...
        >
          ...
          >
            ...
            <span className="text-base">{t(lang, "continueWithGoogle")}</span>
          </button>
          <button
            type="button"
            onClick={onOpenSignUp}
            className="w-full mt-3 py-3 rounded-xl font-semibold text-green-300 transition-colors hover:text-green-200"
          >
